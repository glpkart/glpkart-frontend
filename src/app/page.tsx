...
// WhatsApp number â update when AiSensy number is live
...
const FAQS = [
  ...
  { q: "What's the difference between branded and generic?", a: 'Generic GLP-1 medications contain the same active ingredient at the same dose as branded versions but cost 60â70% less. Your doctor will discuss both options and recommend based on your goals and budget.' },
  ...
  { q: 'How does the WhatsApp consultation work?', a: 'After checking your eligibility, message us on WhatsApp. Our team will verify your quiz answers, connect you with an available endocrinologist, and the doctor will call you directly on WhatsApp for a 30-minute consultation. Everything happens on WhatsApp â no app downloads, no login required.' },
]
...
export default function HomePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: CREAM, fontFamily: SANS, color: INK, overflowX: 'hidden' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, paddingBottom: 40 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }} className="stat-cards-sub">
              ...
              <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: '20px 24px' }}>
                ...
                <div style={{ fontFamily: SERIF, fontSize: 28, fontWeight: 700, color: 'white', lineHeight: 1 }}>â¹799</div>
      ...
      <div id="how-it-works" style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }} className="steps-grid">
          {[
            ...
            { n: '03', title: 'Receive medication', body: 'Licensed GLP-1 â branded or generic. Prescription shared on WhatsApp. Delivered discreetly in Mumbai within 48 hours.', icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><ellipse cx="11" cy="11" rx="8" ry="5" stroke={G} strokeWidth="1.5"/><path d="M3 11h16" stroke={G} strokeWidth="1.5"/></svg> },
            { n: '04', title: 'Ongoing on WhatsApp', body: 'Weekly check-ins, injection reminders, dose adjustments, and prescription renewals â all managed through WhatsApp.', icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M4 16l4-4 3 3 7-7" stroke={G} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg> },
          ].map((step, i) => (
      ...
      <div id="medication" style={{ background: DARK2, padding: '80px 40px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }} className="meds-grid">
            {[
              { name: 'Semaglutide', type: 'GLP-1 receptor agonist', badge: 'Weekly injection', desc: 'The most studied GLP-1 medication for weight loss. Average 15â18% body weight reduction in clinical trials. Available in branded and generic forms.', feats: ['Once weekly', '0.25mg â 2.4mg', 'Subcutaneous', 'Prescription only'] },
              { name: 'Tirzepatide', type: 'GLP-1 + GIP dual agonist', badge: 'Dual-action', desc: 'Targets two hunger hormones simultaneously. Newer mechanism showing 20â22% weight reduction â the highest of any currently approved medication. Available in branded and generic forms.', feats: ['Once weekly', '2.5mg â 15mg', 'Subcutaneous', 'Prescription only'] },
            ].map((med, i) => (
          ...
          <div style={{ marginTop: 16, padding: '16px 20px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 10, fontSize: 13, color: MUTED, textAlign: 'center' }}>
            Your doctor selects the right medication and dose based on your health history, goals, and budget. Generic options reduce cost by 60â70%.
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 40px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }} className="science-grid">
          <div>
            ...
            <p style={{ fontSize: 15, color: '#4b5563', lineHeight: 1.8, marginBottom: 14 }}>GLP-1 is the hormone your gut releases after eating to signal fullness to your brain. In many people, this signal is weaker than it should be â making appetite feel impossible to control.</p>
            <p style={{ fontSize: 15, color: '#4b5563', lineHeight: 1.8 }}>GLP-1 therapy restores this signal. You feel full sooner. You eat less naturally. Weight loss follows â measurably and consistently.</p>
            <div style={{ marginTop: 24, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {[{ n: '68 weeks', l: 'avg trial duration' }, { n: '2Ã faster', l: 'vs diet + exercise' }, { n: '85%', l: 'lose >5% body weight' }].map((st, i) => (
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20 }} className="trust-grid">
            {[
              ...
              { title: 'Everything on WhatsApp', body: 'Consultation, prescription, reminders, and support â all in your existing WhatsApp.' },
      ...
      {/* WhatsApp CTA section â replaces community sign-in wall */}
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 40px' }}>
        <div style={{ background: DARK, borderRadius: 24, padding: '60px 48px', display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'center' }} className="cta-grid">
          <div>
            ...
            <div style={{ marginTop: 24, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {['No app download', 'Doctor calls you', 'â¹799 consultation'].map((f, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: MUTED }}>
      ...
      <div style={{ background: DARK, padding: '90px 40px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 16, color: FAINT, marginBottom: 40, lineHeight: 1.75 }}>Check eligibility in 3 minutes. Then message us on WhatsApp â a doctor calls you.</p>
