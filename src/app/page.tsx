  ...
  return (
    <div style={{ minHeight: '100vh', background: CREAM, fontFamily: SANS, color: INK, overflowX: 'hidden' }}>
      ...
      <div style={{ background: G, color: 'white', textAlign: 'center', padding: '9px 20px', fontSize: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
        ...
        Doctors available today in Mumbai &nbsp; · &nbsp; GLP-1 consultations on WhatsApp
      </div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 40px 0', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'end' }} className="hero-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, paddingBottom: 40 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }} className="stat-cards-sub">
              ...
              <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: '20px 24px' }}>
                <div style={{ fontSize: 11, color: MUTED, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8 }}>FAST DELIVERY</div>
                <div style={{ fontFamily: SERIF, fontSize: 28, fontWeight: 700, color: 'white', lineHeight: 1 }}></div>
      ...
      {/* Marquee */}
      <div style={{ overflow: 'hidden', background: '#f0fdf6', padding: '10px 0', borderTop: '1px solid #e5e7eb', borderBottom: '1px solid #e5e7eb' }}>
        <div style={{ display: 'inline-block', whiteSpace: 'nowrap', animation: 'marquee 25s linear infinite' }}>
          {[1,2].map(k => (
            <span key={k} style={{ fontSize: 13, color: '#374151', marginRight: 60 }}>
      ...
      {/* Mission */}
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '48px 40px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: SERIF, fontSize: 32, fontWeight: 700, color: INK, lineHeight: 1.3, marginBottom: 16 }}>
          Make world-class metabolic care<br />reachable for every Indian.
        </h2>
        <p style={{ fontSize: 16, color: '#4b5563', lineHeight: 1.85, maxWidth: 640, margin: '0 auto 20px' }}>
      ...
      {/* GLPKart Package */}
      <div style={{ background: '#111d11', padding: '72px 40px' }}>
      ...
      </div>{/* WhatsApp CTA section  --  replaces community sign-in wall */}
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 40px' }}>
        <div style={{ background: DARK, borderRadius: 24, padding: '60px 48px', display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'center' }} className="cta-grid">
          <div>
            ...
            <div style={{ marginTop: 24, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {['No app download', 'Doctor calls you', ' consultation'].map((f, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: MUTED }}>
